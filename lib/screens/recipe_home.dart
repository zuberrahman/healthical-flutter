...
import 'package:healthical_flutter_clone/model/meal_plan_model.dart';
import 'package:healthical_flutter_clone/screens/meals_screen.dart';
import 'package:healthical_flutter_clone/services/api_service.dart';

class Recipe_Home_Screen extends StatefulWidget {
  const Recipe_Home_Screen({Key? key}) : super(key: key);

  @override
  State<Recipe_Home_Screen> createState() => _Recipe_Home_ScreenState();
}

class _Recipe_Home_ScreenState extends State<Recipe_Home_Screen> {
  List<String> _diets = [
